          ...
          <div class="box">
            ...
            <div class="box-body pad">
             Date :
              ...
              <input class="form-control input-sm" style="width: 20%;" type="text">
              ...
              <tr>
              <td>In :</td>
              <td><input class="form-control input-sm" style="width: 60%;" type="text"></td>
              <td>Out :</td>
             <td>  <input class="form-control input-sm" style="width: 60%;" type="text"></td>
              <td>Total Hour :</td>
             <td>  <input class="form-control input-sm" style="width: 60%;" type="text"></td>
              ...
              <div class="clear" style="height:10px;"></div>
                 Remarks :
              <div class="clear" style="height:5px;"></div>
              <input class="form-control input-sm" style="width: 10%;" type="text">
              <div class="clear" style="height:10px;"></div>
            Description :
            <div class="clear" style="height:5px;"></div>
              <form>
