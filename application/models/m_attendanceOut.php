<?php
	...
	class m_attendanceOut extends CI_Model
	{
	 ...
	 /**
	     ...
	     */
	    const TABLE_NAME = 'outtable';
	
	    /**
	     * @name string PRI_INDEX Holds the name of the tables' primary index used in this model
	     */
	    const PRI_INDEX = 'sta_id';
	    ...
	    public function attendanceOut($staff_id)
	    {	    	
	    	//$this->load->library("my_func");

	    	  if ($this->db->insert(self::TABLE_NAME, $staff_id)) {
